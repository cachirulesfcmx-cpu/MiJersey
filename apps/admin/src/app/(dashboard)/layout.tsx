...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/analytics', label: 'Analítica', permission: 'admin:access' },
  { href: '/tracking-providers', label: 'Proveedores de tracking', permission: 'admin:access' },
  { href: '/tracking-events', label: 'Eventos de tracking', permission: 'admin:access' },
  { href: '/notifications', label: 'Notificaciones', permission: 'admin:access' },
  { href: '/home', label: 'Home', permission: 'admin:access' },
  { href: '/cms-pages', label: 'Páginas', permission: 'admin:access' },
  { href: '/blog-posts', label: 'Blog', permission: 'admin:access' },
  { href: '/navigation-menus', label: 'Navegación', permission: 'admin:access' },
  { href: '/theme', label: 'Tema', permission: 'admin:access' },
  { href: '/site-configuration', label: 'Configuración del sitio', permission: 'admin:access' },
  { href: '/email-templates', label: 'Plantillas de correo', permission: 'admin:access' },
  ...
  { href: '/promotions', label: 'Promociones', permission: 'admin:access' },
  { href: '/promotion-usage', label: 'Uso de promociones', permission: 'admin:access' },
  { href: '/shipping-methods', label: 'Métodos de envío', permission: 'admin:access' },
  { href: '/orders', label: 'Pedidos', permission: 'admin:access' },
  { href: '/payments', label: 'Reembolsos', permission: 'admin:access' },
  { href: '/shipping-config', label: 'Config. de envíos', permission: 'admin:access' },
  { href: '/shipments', label: 'Envíos', permission: 'admin:access' },
  { href: '/support-tickets', label: 'Tickets de soporte', permission: 'admin:access' },
  { href: '/support-rma', label: 'Devoluciones (RMA)', permission: 'admin:access' },
...
const BREADCRUMB_LABELS: Record<string, string> = {
  '/': 'Dashboard',
  '/analytics': 'Analítica',
  '/analytics/dashboards': 'Dashboards configurables',
  '/tracking-providers': 'Proveedores de tracking',
  ...
  '/navigation-menus': 'Navegación',
  '/theme': 'Tema',
  '/site-configuration': 'Configuración del sitio',
  '/email-templates': 'Plantillas de correo',
  '/email-layouts': 'Layouts de correo',
  '/products': 'Productos',
  ...
  '/promotion-usage': 'Uso de promociones',
  '/shipping-methods': 'Métodos de envío',
  '/orders': 'Pedidos',
  '/payments': 'Reembolsos',
  '/shipping-config': 'Config. de envíos',
  '/shipments': 'Envíos',
  '/support-tickets': 'Tickets de soporte',
  '/support-rma': 'Devoluciones (RMA)',
